# -*- coding: utf-8 -*-
"""
Deep Multimodal Image Influence Evaluation V2
---------------------------------------------
"""
...
class DeepInfluenceEvaluatorV2:
    ...
    def generate_turn(
        ...
        print("IMAGE TOKENS:", prompt.count("<image>"))
    ...
    def evaluate_ablation_variants(
        ...
        for name, abl_img in ablation_images.items():
    ...
    def run_all(self) -> Dict[str, Any]:
        all_cases = self.build_cases_from_file()
        results = []
        t0 = time.time()

        for case in all_cases:
            print(f"[RUN] {case['case_id']} / {case['variant_id']}")
            results.append(self.run_multiturn_case(case))
